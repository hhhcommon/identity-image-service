...
public class TestIdentityIdnumberVerificationStateless {
     public static final String filepath = "C:/api_doc/fanbingbing2.jpg";//图片路径
  //  public static final String filepath = "C:/api_doc/2.jpeg";//图片路径
